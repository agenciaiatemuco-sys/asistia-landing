    ...
    <section id="planes" className="py-20 bg-slate-50 border-t border-slate-100">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-4">
          ...
          <p className="text-slate-500 text-lg">Todos los planes incluyen las mismas funciones. Solo cambia el volumen de conversaciones y los colaboradores.</p>
        </div>
        <p className="text-center text-sm text-slate-400 mb-12">Sin costo de instalación · Sin contrato de permanencia</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6 items-start">
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-200 flex flex-col shadow-sm hover:shadow-md transition-shadow">
            ...
            <span className="inline-block bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full mb-5 w-fit">14 días gratis, sin tarjeta</span>
            <ul className="space-y-2.5 text-sm text-slate-600 mb-7 flex-1">
              <li className="flex items-center gap-2"><span className="text-emerald-500 font-bold">✓</span> Hasta 400 interacciones/mes</li>
            ...
            <a href={`${DASHBOARD_URL}/contratar?plan=micro`}
               onClick={trackLead}
          ...
          <div className="bg-emerald-700 rounded-2xl p-7 border-2 border-emerald-500 flex flex-col shadow-xl shadow-emerald-900/20 lg:-translate-y-2">
            ...
            <p className="text-emerald-200 text-sm mb-4">Para negocios con equipo pequeño que necesitan colaboración.</p>
            <span className="inline-block bg-emerald-500/30 text-emerald-200 text-xs font-bold px-3 py-1 rounded-full border border-emerald-500/40 mb-5 w-fit">14 días gratis, sin tarjeta</span>
            <ul className="space-y-2.5 text-sm text-emerald-100 mb-7 flex-1">
              <li className="flex items-center gap-2"><span className="text-emerald-300 font-bold">✓</span> Hasta 1.000 interacciones/mes</li>
            ...
            <a href={`${DASHBOARD_URL}/contratar?plan=starter`}
               onClick={trackLead}
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-200 flex flex-col shadow-sm hover:shadow-md transition-shadow">
            ...
            <ul className="space-y-2.5 text-sm text-slate-600 mb-7 flex-1">
              <li className="flex items-center gap-2"><span className="text-emerald-500 font-bold">✓</span> Hasta 3.000 interacciones/mes</li>
            ...
            <a href={`${DASHBOARD_URL}/contratar?plan=pro`}
               onClick={trackLead}
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-200 flex flex-col shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-slate-500 text-sm mb-4">Para empresas con alto volumen y múltiples agentes.</p>
            <ul className="space-y-2.5 text-sm text-slate-600 mb-7 flex-1">
              <li className="flex items-center gap-2"><span className="text-emerald-500 font-bold">✓</span> Hasta 10.000 interacciones/mes</li>
            ...
            <a href={`${DASHBOARD_URL}/contratar?plan=business`}
               onClick={trackLead}
               className="block w-full py-3 text-center bg-slate-900 text-white font-bold rounded-xl hover:bg-slate-800 transition text-sm">
              Contratar ahora
            </a>
