    ...
    <section id="planes" className="py-20 bg-slate-50 border-t border-slate-100">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 text-lg">Todos incluyen panel completo, agendamiento y soporte. Sin costo de activación.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6 items-start">
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-200 flex flex-col shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-slate-500 text-sm mb-4">Para profesionales independientes que atienden solos.</p>
            <span className="inline-block bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full mb-5 w-fit">🎉 14 días gratis</span>
          ...
          <div className="bg-emerald-700 rounded-2xl p-7 border-2 border-emerald-500 flex flex-col shadow-xl shadow-emerald-900/20 lg:-translate-y-2">
            ...
            <span className="inline-block bg-emerald-500/30 text-emerald-200 text-xs font-bold px-3 py-1 rounded-full border border-emerald-500/40 mb-5 w-fit">🎉 14 días gratis</span>
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-200 flex flex-col shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-slate-500 text-sm mb-4">Para clínicas y centros con mayor volumen de atención.</p>
        ...
        <div className="bg-slate-900 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 border border-slate-800">
          <div>
            ...
            <p className="text-slate-400 text-sm max-w-lg">Más de 10.000 interacciones, múltiples instancias, integraciones personalizadas. Diseñamos la solución para tu operación.</p>
          </div>
